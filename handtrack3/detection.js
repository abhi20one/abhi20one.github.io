...
function checkIfZoomFingersOpen(handLandmarks) {
    ...
    const openAngleThreshold = 165; 


    const thumbOpen = angleBetween(handLandmarks[1], handLandmarks[2], handLandmarks[3]) > 175;
...
function checkIfFingersAreClose(handLandmarks) {
    ...
    const ringThumbDist = dist(handLandmarks[16].x, handLandmarks[16].y, handLandmarks[4].x, handLandmarks[4].y);
